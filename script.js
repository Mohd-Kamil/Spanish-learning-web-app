...
function loadLesson() {
    ...
    // Setup drag and drop if it's a drag-drop exercise
...
function createMultipleChoiceExercise(lesson) {
    ...
    lesson.options.forEach((option, index) => {
        optionsHTML += `
            <div class="exercise-option" onclick="checkAnswer(${index}, ${lesson.correct})">
    ...
    return `
        <div class="exercise-container">
            <div class="exercise-header">
                ...
                <div class="exercise-type-badge">Multiple Choice</div>
            </div>
...
function createFillBlankExercise(lesson) {
    return `
        <div class="exercise-container">
            <div class="exercise-header">
                <h4 class="exercise-question">${lesson.question}</h4>
                <div class="exercise-type-badge">Fill in the Blank</div>
            </div>
            <div class="fill-blank-container">
                <div class="input-group">
                    <input type="text" id="fillBlankAnswer" class="form-control" placeholder="Type your answer..." autocomplete="off">
                    <button class="btn btn-primary" onclick="checkFillBlankAnswer()">
...
function createDragDropExercise(lesson) {
    ...
    return `
        <div class="exercise-container">
            <div class="exercise-header">
                <h4 class="exercise-question">${lesson.question}</h4>
                <div class="exercise-type-badge">Drag & Drop</div>
            </div>
            ...
            <div class="exercise-actions">
                <button class="btn btn-primary" onclick="checkDragDropAnswer()">
                    <i class="fas fa-check"></i> Check Answer
                </button>
                <button class="btn btn-outline-secondary" onclick="resetDragDrop()">
...
function checkDragDropAnswer() {
    ...
    const userOrder = droppedItems.map(item => item.dataset.item);
    const lesson = lessonData[currentModule][currentLessonIndex];
...
function completeModule() {
    showNotification('🎉 Module completed! Congratulations!', 'success');
    awardXP(50);
